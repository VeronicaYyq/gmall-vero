...
public class SpuInfoListener {
    ...
    public void listener(Map<String,Object> map){
        ...
        if(spuId!=null){
            Resp<List<SkuInfoEntity>> skuResp = this.gmallPmsClient.queSkuInfoFromSpu(spuId);
            ...
            if (!CollectionUtils.isEmpty(skuInfoEntities)) {
                ...
                skuInfoEntities.forEach(skuInfoEntity -> {
                    ...
                    // 设置搜索属性
                    Resp<List<ProductAttrValueEntity>> attrResp = this.gmallPmsClient.querySearchAttrValue(spuId);
